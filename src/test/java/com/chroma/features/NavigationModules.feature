Feature: A CTSMS user is able to see Navigation modules on portal
    ...
    Scenario: Navigation modules are displayed on portal
        ...
        Then user is able to see links displayed "Student Information", "Fees Collection", "Income", "Expenses", "Academics", "Human Resourse", "Homework", "Reports"
